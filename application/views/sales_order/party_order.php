                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="button" class="btn waves-effect waves-light btn-outline-primary float-right addNew press-add-btn permission-write" data-button="both" data-modal_id="modal-xl" data-function="addPartyOrder" data-fnsave="savePartyOrder" data-form_title="Add Order"><i class="fa fa-plus"></i> Add Order</button>
                            </div>                             
                        </div>                                         
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='partyOrderTable' class="table table-bordered ssTable" data-url='/getPartyOrderDTRows'></table>
                        </div>
                    </div>
                </div>
            </div>
