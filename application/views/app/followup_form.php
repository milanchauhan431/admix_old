<form data-res_function="resFollowup">
    <div class="action-sheet-content">
        ...
        <div class="form-group  boxed animated hidden">
        ...
        <div class="form-group  boxed animated">
            <button type="button" class="btn waves-effect waves-light btn-outline-success btn-save float-right mt-30" onclick="customStore({'formId':'followUp','fnsave':'saveFollowup','controller':'lead','controller':'lead'},);"> <i class="fa fa-check"></i> Save</button>
        </div>
        <hr>
