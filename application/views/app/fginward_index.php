									...
									<div class="listItem item transition "  data-category="transition">
										<div class="in ">
											<div>
												...
												<div class="text-small  text-secondary"><label class="text-bold">Date : </label> '.formatDate($row->ref_date).' | <label class="text-bold">Date : </label>'.formatDate($row->ref_date).'</div>
												<div class="text-small text-secondary "> <label class="text-bold">Packing Standard : </label> '.$row->size.'</div>
